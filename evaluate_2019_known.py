...
def is_unclass_misclass(taxid, max_year, fold):
...
if __name__ == "__main__":
    ...
    np.savetxt("species_to_2019.txt", species_scores, delimiter=',')
    np.savetxt("genus_to_2019.txt", genus_scores, delimiter=',')
    np.savetxt("phylum_to_2019.txt", phylum_scores, delimiter=',')
    np.savetxt("family_to_2019.txt", family_scores, delimiter=',')
    np.savetxt("order_to_2019.txt", order_scores, delimiter=',')
    np.savetxt("class_to_2019.txt", class_scores, delimiter=',')
