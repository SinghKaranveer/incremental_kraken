...
echo "2011"
/mnt/HA/groups/rosenclassGrp/Kraken_tutorial/kraken2/kraken2-build --build --db /scratch/djd378/kraken_db_fold4/2011

echo "2012"
/mnt/HA/groups/rosenclassGrp/Kraken_tutorial/kraken2/kraken2-build --build --db /scratch/djd378/kraken_db_fold4/2012

echo "2013"
/mnt/HA/groups/rosenclassGrp/Kraken_tutorial/kraken2/kraken2-build --build --db /scratch/djd378/kraken_db_fold4/2013

echo "2014"
/mnt/HA/groups/rosenclassGrp/Kraken_tutorial/kraken2/kraken2-build --build --db /scratch/djd378/kraken_db_fold4/2014
